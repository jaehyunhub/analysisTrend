        ...
        <div className="max-w-[1200px] mx-auto px-6">
          ...
          <div className="flex flex-col md:flex-row gap-12 mb-20">
            ...
            <div className="flex-1">
              <div data-testid="image-slider" className="relative aspect-square w-full rounded-2xl overflow-hidden mb-4 group">
                ...
                {/* Image counter */}
                <div data-testid="image-counter" className="absolute top-3 right-3 bg-black/50 text-white text-xs font-bold px-2 py-1 rounded-full">
