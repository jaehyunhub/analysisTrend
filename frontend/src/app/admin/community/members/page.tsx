    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400 text-sm">Manage community members and bans.</p>
        </div>
      ...
      <div className="bg-white dark:bg-[#1A1A1B] rounded-xl border border-gray-200 dark:border-[#343536] overflow-hidden">
          <table className="w-full text-left text-sm">
              <thead className="bg-gray-50 dark:bg-[#272729] text-gray-500 font-bold border-b border-gray-100 dark:border-[#343536]">
                  <tr>
              ...
              <tbody className="divide-y divide-gray-100 dark:divide-[#343536]">
                  {members.map(member => (
                      <tr key={member.id} className="hover:bg-gray-50 dark:hover:bg-[#272729]">
                          ...
                          <td className="p-4 text-gray-500">{member.joinDate}</td>
                          <td className="p-4">
