...
export default function PostDetailModal() {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/70 backdrop-blur-sm p-4" onClick={closePostDetail}>
      <div 
      ...
      >
        ...
        <div className="w-[350px] bg-white dark:bg-[#1A1A1B] border-l border-gray-200 dark:border-[#343536] flex flex-col hidden md:flex">
             <div className="p-4 border-b border-gray-200 dark:border-[#343536] flex justify-between items-center">
                 ...
                 <button onClick={closePostDetail} className="text-gray-500 hover:text-black">Close</button>
             </div>
